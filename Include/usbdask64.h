...
#define ErrorInvlaidSyncMode          -330
...
#define I2C_STOP   1
    ...
    I16 __stdcall UD_AI_EventCallBack_x64 ( U16 CardNumber, I16 mode, I16 EventType, \
    ...
    I16 __stdcall UD_AO_EventCallBack_x64 ( U16 CardNumber, I16 mode, I16 EventType, \
                                        ULONG_PTR callbackAddr );  
    ...
    I16 __stdcall UD_AI_GetView_x64 ( U16 CardNumber, ULONG_PTR *View );

    I16 __stdcall UD_AO_GetView_x64 ( U16 CardNumber, ULONG_PTR *View );
